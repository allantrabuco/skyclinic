/*
 * File: app/controller/ItensList.js
 */

Ext.define('skyclinic.controller.ItensList', {
    extend: 'Ext.app.Controller',

    control: {
        "itenslist container[name=search] textfield[name=search]": {
            keyup: 'onSearchTextfieldKeyup'
        },
        "itenslist container[name=search] button[action=search]": {
            click: 'onSearchButtonClick'
        },
        "itenslist container[name=search] button[action=clean]": {
