/*
 * File: app/controller/TransportadorasList.js
 */

Ext.define('skyclinic.controller.TransportadorasList', {
    extend: 'Ext.app.Controller',

    control: {
        "simplelist container[name=search] textfield[name=search]": {
            keyup: 'onSearchTextfieldKeyup'
        },
        "simplelist container[name=search] button[action=search]": {
            click: 'onSearchButtonClick'
        },
        "simplelist container[name=search] button[action=clean]": {
