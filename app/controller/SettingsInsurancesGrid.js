/*
 * File: app/controller/SettingsInsurancesGrid.js
 */

Ext.define('skyclinic.controller.SettingsInsurancesGrid', {
    ...
    control: {
        "settingsinsurancesgrid": {
            ...
            afterrender: 'onSettingsInsurancesGridAfterRender'
        }
    },
    ...
    onRowEditingValidateedit: function(editor, context, eOpts) {
        ...
        parameters.push({'tbl':'settInsurances'});
    ...
    onSettingsInsurancesGridAfterRender: function(component, eOpts) {
        var me = this,
            cmp = component,
